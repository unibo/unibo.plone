...
#
#  $ bin/test -s unibo.plone -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src unibo.plone.testing.UNIBO_PLONE_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/unibo/plone/tests/robot/test_example.robot
#
